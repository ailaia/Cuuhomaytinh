...
<!-- Bắt đầu code -->
    ...
    <?php
            ...
            $sql ="INSERT INTO `booking_ch`(`ch_id`, `guest_id`, `booking_guest_name`, `booking_guest_address`, `booking_guest_number`,`booking_guest_email`, `booking_day` )
            VALUES ($ch_id,$guest_id,'$booking_guest_name', '$booking_guest_address','$booking_guest_number','$booking_guest_email', '$booking_day')";
            $result = mysqli_query($conn,$sql);
    ?>
            <section>
            <h1 class="my-4 fs-1 fw-bold fst-italic text-center" >Thông tin khách hàng vừa đặt</h1>
                <div class="container  bg-danger p-2 text-dark bg-opacity-10 ">
                    ...
                    <p class=" fs-4 fst-italic"> Thời gian đặt lịch:  <?php echo $booking_day ?></p>
